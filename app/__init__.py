...
app.config['MYSQL_DB'] = 'inventory_alkes'
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root@localhost/inventory_alkes'
app.config['SECRET_KEY'] = os.getenv("SECRET_KEY")
app.config['SECURITY_PASSWORD_HASH'] = 'bcrypt'
app.config['SECURITY_PASSWORD_SALT'] = os.getenv("SECURITY_PASSWORD_SALT").encode()
